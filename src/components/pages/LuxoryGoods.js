...
const LuxoryGoods = () => {
  return (
    ...
    text2="Distinkt's impeccable sources gets what one possibly wants! Whether it be in another continent, borders don’t exist for us to obtain what our client has requested!"
